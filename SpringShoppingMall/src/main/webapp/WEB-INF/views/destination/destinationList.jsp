...
<tr>
	...
	<td>
		<button onclick="javascript:location.href='destwrited.action';"
	...
	<tr>
		<td class="check_wrap check_only">
			<c:if test="${dto.addrKey=='no' }">
				<a href="changeAddrkey_ok.action?destNickname=${dto.destNickname }">
		...
		<td>${dto.destPhone }</td>
		<td>
			<button onclick="javascript:location.href='destupdated.action?destNickname=${dto.destNickname }';" class="btn_sm_bordered" >
				수정하기
			</button>
		</td>
		<td>
			<button onclick="javascript:location.href='destdeleted.action?destNickname=${dto.destNickname }'" class="btn_sm_bordered" >
				삭제하기
			</button>
		</td>
	</tr>
