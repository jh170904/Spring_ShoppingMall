...
<script>
	...
	function initLayerPosition() {
		...
		document.getElementById('layer').style.border = borderWidth
				+ 'px solid';
		// 실행되는 순간의 화면 너비와 높이 값을 가져와서 중앙에 뜰 수 있도록 위치를 계산한다.
		document.getElementById('layer').style.left = (((window.innerWidth || document.documentElement.clientWidth) - width) / 2 - borderWidth)
				+ 'px';
		document.getElementById('layer').style.top = (((window.innerHeight || document.documentElement.clientHeight) - height) / 2 - borderWidth)
				+ 'px';
	}
</script>
...
<div class="ap_contents mypage" style="position: relative;">
	...
	<fieldset class="form">
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="destNickname" maxlength="50" value="${dto.destNickname }"
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="destName" maxlength="50" value="${dto.destName }"
					class="input_wrap w100p">
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="destPhone" maxlength="50" value="${dto.destPhone }" 
					class="input_wrap w100p">
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="destTel" maxlength="50" value="${dto.destTel }"
					class="input_wrap w100p">
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
			<input type="text" name="zip" id="zip" readonly="readonly" value="${dto.zip }" class="input_wrap w65p">
		...
		<tr>
			<td style="padding-left: 20px;" height="50">
				<input type="text" name="addr1" id="addr1" readonly="readonly" value="${dto.addr1 }" class="input_wrap w100p">
			</td>
		</tr>
		<tr>
			<td style="padding-left: 20px;" height="50">
				<input type="text" name="addr2" id="addr2" value="${dto.addr2 }" class="input_wrap w100p">
			</td>
		</tr>
	</fieldset>
	</table>
	...
	<tr align="center">
		<td colspan="2">
			...
			<input type="button" class="btn_blg_primary sendButton"value="수정" onclick="updateDest();">
		</td>
	</tr>
