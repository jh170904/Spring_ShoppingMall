...
<script type="text/javascript">
	function updateDest() {
	    ...
	    f.action = "destupdated_ok.action";
	    f.submit();
...
<tr class="page_title">
	<td colspan="2" align="center">
		<h2 class="h_title page">배송지 수정</h2>
...
<tr>
	...
	<td style="padding-left: 20px;">
	<input type="text" name="zip" id="zip" readonly="readonly" value="${dto.zip }" class="input_wrap w70p" style="padding: 10px 0px;">
...
<tr>
	<td style="padding-left: 20px;" height="50">
		<input type="text" name="addr1" id="addr1" readonly="readonly" value="${dto.addr1 }" class="input_wrap w100p" style="padding: 10px 0px;">
	</td>
</tr>
<tr>
	<td style="padding-left: 20px;" height="50">
		<input type="text" name="addr2" id="addr2" value="${dto.addr2 }" class="input_wrap w100p" style="padding: 10px 0px;">
	</td>
</tr>
