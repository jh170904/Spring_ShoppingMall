	...
	<div class="title">상품 수정</div>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="productId" size="30" maxlength="20" value="${dto.productId }" readonly="readonly" 
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="superProduct" size="30" maxlength="20" value="${dto.superProduct }" readonly="readonly"
					class="input_wrap w100p" style="background-color: #F5F5F5">
			</td>
		</tr>
			...
			<td style="padding-left: 20px;">
				<select name="productCategory" class="input_wrap w100p">
	  				...
	  				<c:forTokens var='item' items="OUTER,TOP,BOTTOM,DRESS,SHOES,BAG,ACC" delims="," >
						<option value="${item}" <c:if test="${item eq dto.productCategory }">selected='selected'</c:if> >${item}</option>
					</c:forTokens>
				</select>
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="productName" size="30" maxlength="100" value="${dto.productName }" readonly="readonly"
					class="input_wrap w100p" style="background-color: #F5F5F5">
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
			<input type="text" name="productSize" size="30" maxlength="100" value="${dto.productSize }"
			...
			<td style="padding-left: 20px;">
				<select name="color" class="input_wrap w100p">
					...
					<c:forTokens var='item' items="핑크,레드,오렌지,보라,블랙,그레이,브라운,그린,블루,옐로우,베이지,화이트,실버" delims="," >
						<option value="${item}" <c:if test="${item eq dto.color }">selected='selected'</c:if> >${item}</option>
					</c:forTokens>
				</select>
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="storeName" size="30" maxlength="100" value="${dto.storeName }"
					class="input_wrap w100p">
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
			<input type="text" name="storeUrl" size="30" maxlength="100" value="${dto.storeUrl }"
					class="input_wrap w100p">
			</td>
		</tr>
			...
			<td style="padding-left: 20px;">
				<select name="state" class="input_wrap w100p">
					...
					<c:forTokens var='item' items="판매중,일시품절,판매중지" delims="," >
						<option value="${item}" <c:if test="${item eq dto.state }">selected='selected'</c:if> >${item}</option>
					</c:forTokens>
				</select>
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="price" size="30" maxlength="100" value="${dto.price }"
					class="input_wrap w100p">
			</td>
		</tr>
