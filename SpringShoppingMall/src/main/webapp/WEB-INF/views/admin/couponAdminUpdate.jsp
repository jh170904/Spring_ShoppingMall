...
<script type="text/javascript">
	...
	function couponSendIt(){
		...
		f.action = "<%=cp %>/admin/couponAdminUpdate_ok.action";
		f.submit();
	...
	<div class="title">쿠폰 등록</div>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="couponName" size="30" maxlength="20" value="${dto.couponName }"
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="discount" size="30" maxlength="20" value="${dto.discount }"
					class="input_wrap w100p">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="couponScore" size="30" maxlength="20" value="${dto.couponScore }"
					class="input_wrap w100p">
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="couponGrade" size="30" maxlength="20" value="${dto.couponGrade }" readonly="readonly"
		...
		<tr>
			...
			<td style="padding-left: 20px;">
				<input type="text" name="period" size="30" maxlength="20" value="${dto.couponEndDate }" readonly="readonly"
					class="input_wrap w100p" style="background-color: #F5F5F5">
			</td>
		</tr>
		<tr>
		...
		<tr align="center">
			<td align="center">
				...
				<button class="btn_blg_primary sendButton" type="button" onclick="couponSendIt();">쿠폰 수정</button>
				...
				<button class="btn_blg_secondary sendButton" type="reset" onclick="document.couponMyForm.couponName.focus();">다시입력</button>
			</td>
		</tr>
