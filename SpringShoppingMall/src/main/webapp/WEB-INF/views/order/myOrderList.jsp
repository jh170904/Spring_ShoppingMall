...
<div class="ap_contents mypage coupon">
	...
	<div class="ui_tab prd_detail_tap">
		...
		<div style="margin-left: 12px;">
			<dl>
				<dd class="inLine_myOrder"><button onclick="javascript:location.href='myOrderLists.action?period=week';" 
				...
				<dd class="inLine_myOrder"><button onclick="javascript:location.href='myOrderLists.action?period=month';" 
				...
				<dd class="inLine_myOrder"><button onclick="javascript:location.href='myOrderLists.action?period=3month';" 
				...
				<dd class="inLine_myOrder"><button onclick="javascript:location.href='myOrderLists.action?period=6month';" 
				...
				<dd class="inLine_myOrder"><button onclick="javascript:location.href='myOrderLists.action?period=year';" 
						...
						<c:forEach var="dto" items="${userOrderlist }">
							<tr>
								...
								<td style="vertical-align: top; text-align: left;">
									<a href="detail.action?superProduct=${dto.superProduct}">
										<img alt="" src="${imagePath }/${dto.saveFileName }" height="50px;">
									</a>
								</td>
								<td style="vertical-align: top; text-align: left;">
									<a href="detail.action?superProduct=${dto.superProduct}">${dto.productName }</a>
