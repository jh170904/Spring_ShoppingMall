...
<form name="orderDestInserForm" method="post">
...
<tr align="center">
	<td colspan="2">
		<input type="button" class="btn_blg_secondary" value="취소" onclick="destInsertClose()">
		<input type="button" class="btn_blg_primary" value="등록" onclick="orderDest();">
	</td>
</tr>
