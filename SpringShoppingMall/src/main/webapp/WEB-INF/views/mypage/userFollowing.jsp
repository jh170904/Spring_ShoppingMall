...
<div style="width: 100%; overflow: visible; border-bottom: solid 1px #dbdbdb; text-align: center;">
	<ul>
		<li class="page-navigation__item"><a href="<%=cp %>/pr/userFollower.action?userId=${userId }">팔로워</a></li>
		<li class="page-navigation__item" style=" color: #8080FF"><a href="<%=cp %>/pr/userFollowing.action?userId=${userId }">팔로잉<div style="height: 4px; background-color: #8080FF"/></div></a></li>
	</ul>
</div>
