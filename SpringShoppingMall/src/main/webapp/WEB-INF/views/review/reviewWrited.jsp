...
<script type="text/javascript">
	...
	function writeReview() {
		...
		f.action = "reviewWrited_ok.action";
		f.submit();
	}
...
<tr align="center">
	<td colspan="2">
		...
		<input type="button" class="btn_blg_secondary" value="취소" onclick="javascript:location.href='reviewPossibleList.action?pageNum=${pageNum}';">
