...
<div class="ap_contents mypage coupon">
	...
	<div class="ui_tab">
		...
		<div class="tab_menu equally">
			<ul>
				<li><a href="reviewList.action?order=recent">작성한 리뷰 <b id="availCnt">${dataCount_yes }</b>개</a></li>
				<li class="on"><a href="reviewPossibleList.action">작성 가능한 리뷰 <b id="expCnt">${dataCount_no }</b>개</a></li>
			</ul>
		</div>
